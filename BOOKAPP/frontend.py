...
# database es un objeto que este a su vez es una instancia de la class Database
...
class Window(object):
    def __init__(self, window):
        ...
        self.window.wm_title("Bookstore DB")
        #--------------------- LABELS-------------------------
        ...
        self.list1=Listbox(window,exportselection=False,height=6,width=35)
        ...
        # bind method es para poner un widget event en este caso el evento es
        # seleccionar un objeto de la lista, 1er argumento=event 2do argu=func
